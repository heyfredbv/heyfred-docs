...
title: "HeyFred Tool"
icon: "phone"
description: "Learn how to use HeyFred triggers and actions in your AI calling flows"
---

# HeyFred Tool

The HeyFred tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the HeyFred tool prominently displayed at the top of the
...
![HeyFred Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![HeyFred Action](/resources/autocalls-action.jpg)
