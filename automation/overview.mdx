...
description: "Learn about HeyFred's built-in automation engine for creating workflows without coding"
---
...
HeyFred includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside HeyFred (e.g., "call ended," "inbound call context injection").
