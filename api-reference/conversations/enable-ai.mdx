---
title: "Enable AI"
api: "POST /user/conversations/{uuid}/enable-ai"
...
```bash cURL
curl -X POST "https://app.heyfred.nl/api/user/conversations/7c9e6679-7425-40de-944b-e07fc1f90ae7/enable-ai" \
...
const response = await fetch(
  `https://app.heyfred.nl/api/user/conversations/${conversationId}/enable-ai`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://app.heyfred.nl/api/user/conversations/{conversation_id}/enable-ai',
