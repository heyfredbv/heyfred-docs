...
icon: "credit-card"
description: "Learn how HeyFred billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

HeyFred operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Beyond 30 seconds, HeyFred bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
