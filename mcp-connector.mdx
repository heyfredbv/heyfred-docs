...
<CardGroup cols={2}>
  ...
  <Card title="Run outbound campaigns" icon="bullhorn" href="/campaigns/index" color="#002C4B">
    ...
    <Steps>
      ...
      <Step title="Paste your link and create">
        ...
        **Authentication** to **OAuth**, tick _"I understand and want to continue"_, then **Create**.
        ...
        <Frame>
          <img src="/resources/mcp/chatgpt-4.png" alt="Paste the HeyFred MCP URL and create the app in ChatGPT" />
        </Frame>
      </Step>
    </Steps>
  </Tab>
