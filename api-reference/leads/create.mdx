...
title: "Create lead"
api: "POST /user/lead"
description: "Create a new lead in the HeyFred system"
---
...
<ParamField body="variables" type="object">
  Custom variables for the lead. For **call** campaigns, use variables defined on your assistant (see [Call variables](/ai-assistants/settings/prompt-and-tools#call-variables)). For **WhatsApp/SMS** campaigns, use the keys referenced by your template mapping or SMS body placeholders.
