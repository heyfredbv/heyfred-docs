...
<CardGroup cols={2}>
  ...
  <Card title="Automation Platform" icon="diagram-project">
    HeyFred **creates a linked flow for you** in the
...
<Note>
  Need more complex logic? Create an **Automation Platform** tool and HeyFred
  builds and links the flow for you — no manual webhook setup required.
</Note>

When you set the tool type to **Automation Platform**, HeyFred automatically
...
<Tip>
  ...
  (e.g. `https://app.heyfred.nl/api/v1/webhooks/abc123/sync`).
</Tip>
