...
The Autocalls connector lets you **build and operate your AI phone agents straight from Claude or
...
<Note>
  ...
  every action stays scoped to **your own Autocalls account** — the connector only ever sees and
  changes your data.
</Note>
...
<CardGroup cols={2}>
  <Card title="Build & refine assistants" icon="robot" href="/ai-assistants/what-is-ai-assistant" color="#06df4b">
  ...
  <Card title="Run outbound campaigns" icon="bullhorn" href="/campaigns/index" color="#06df4b">
    Create campaigns, add and manage leads, and start, pause or resume them.
  </Card>
  <Card title="Review & improve" icon="magnifying-glass-chart" href="/outbound-calls/overview" color="#06df4b">
  ...
  <Card title="Manage your account" icon="gear" href="/api-reference/introduction" color="#06df4b">
...
- An **Autocalls account** at [app.autocalls.ai](https://app.autocalls.ai) — or your white-label
  provider's domain.
  ...
  <Tab title="Claude">
    <Steps>
      ...
      <Step title="Name it and paste your link">
        Type any name (e.g. _Autocalls_), paste your connection link into **Remote MCP server URL**,
        leave the OAuth fields empty, then click **Add**.
        <Frame>
          <img src="/resources/mcp/claude-4.png" alt="Paste the Autocalls MCP URL in Claude" />
        </Frame>
      </Step>
      <Step title="Sign in and approve">
        Log in to your Autocalls account and approve. Your tools then appear in the list — you're
        connected.
        <Frame>
          <img src="/resources/mcp/claude-5.png" alt="Sign in and approve the Autocalls connector in Claude" />
        </Frame>
      </Step>
    </Steps>
  </Tab>
    ...
    <Steps>
      ...
      <Step title="Paste your link and create">
        ...
        **Authentication** to **OAuth**, tick _"I understand and want to continue"_, then **Create**.
        Sign in to your Autocalls account and approve.
        <Frame>
          <img src="/resources/mcp/chatgpt-4.png" alt="Paste the Autocalls MCP URL and create the app in ChatGPT" />
        </Frame>
      </Step>
    </Steps>
  </Tab>
...
<Tip>
  ...
  one click by searching for **Autocalls** under Settings → Connectors — no manual URL needed.
</Tip>
...
- **No chat-history harvesting** — the connector acts only on your Autocalls resources.
- Privacy policy: [autocalls.ai/privacy-policy](https://autocalls.ai/privacy-policy).
...
<AccordionGroup>
  ...
  <Accordion title="Do I need an API key?">
    No. Connection is handled by **OAuth** — you simply sign in to your Autocalls account and approve.
...
Questions? Email [contact@autocalls.ai](mailto:contact@autocalls.ai) or browse the rest of the
