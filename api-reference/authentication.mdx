...
The HeyFred API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your HeyFred account at [https://app.heyfred.nl](https://app.heyfred.nl)
...
```bash
curl -X GET "https://api.heyfred.nl/api/user/campaigns" \
