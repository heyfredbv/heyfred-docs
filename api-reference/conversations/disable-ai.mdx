---
title: "Disable AI"
api: "POST /automate/conversations/{uuid}/disable-ai"
...
```bash cURL
curl -X POST "https://app.heyfred.nl/api/automate/conversations/7c9e6679-7425-40de-944b-e07fc1f90ae7/disable-ai" \
...
const response = await fetch(
  `https://app.heyfred.nl/api/automate/conversations/${conversationId}/disable-ai`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://app.heyfred.nl/api/automate/conversations/{conversation_id}/disable-ai',
